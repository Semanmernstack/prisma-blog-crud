...
function BlogMap({key, data, newUser}:Props) {
  ...
  return (
    <div className='shadow-2xl gap-4 space-y-3 mb-4 text-white rounded-md bg-gray-950  p-4'>
        ...
        {data?.userId === newUser?.id && (
            ...
            <div className="flex items-center gap-4 text-white mt-2 hover:text-slate-500 cursor-pointer text-sm ">
