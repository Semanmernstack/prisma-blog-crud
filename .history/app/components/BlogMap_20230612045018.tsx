    ...
    <div className='shadow-2xl'>
        ...
        {data?.userId === newUser?.id && (
            ...
            <div className="flex items-center gap-4 text-white mt-2 hover:text-slate-500 ">
                <button  onClick={onDelete} className=" cursor-pointer text-[1.5rem]" >Deletete </button>
                <button onClick={() => router.push(`/details/${data.id}`)} className=" cursor-pointer text-[1.2rem]" > Edit</button>
