...
function page() {
  ...
  return (
    ...
    <div className='w-[500px] h-[500px] lg:w-[700px] lg:h-[700px] mx-auto py-12'   >
         <form onSubmit={onSubmit} className='py-12'>
            ...
            <div  className='flex flex-col w-full justify-center items-center h-[450px]  mx-auto gap-2'>
